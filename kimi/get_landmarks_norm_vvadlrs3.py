...
import cv2
import h5py
os.environ["CUDA_VISIBLE_DEVICES"] = "" # Comment out when running on Super computer
from facetools import genMediapipeInfo, clearMediapipeInfo
...
out_main_path = "/home/ksw38/groups/grp_landmarks/nobackup/autodelete/landmarks_vvadlrs3_norm/main"
