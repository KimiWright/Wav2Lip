...
parser.add_argument("--data_root", help="Root folder of the preprocessed landmarks for LRS2 dataset", default="/home/ksw38/groups/grp_landmarks/nobackup/autodelete/landmarks_norm/main")
