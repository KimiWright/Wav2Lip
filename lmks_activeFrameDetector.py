...
from models import SyncNet_landmarks_gru2 as S
...
def load_checkpoint(path, model, optimizer, use_cuda = False, reset_optimizer=False):
    global global_step
    global global_epoch
...
class SyncNetInstance(torch.nn.Module):
    ...
    def __init__(self, vshift=15, batch_size=20):
    ...
    def computeDist(self,feat1,feat2):
        dists = calc_pdist(feat1,feat2,vshift=self.vshift)
    ...
    def evaluate(self, opt, frames):
        ...
        with torch.no_grad():
            ...
            offset, conf, dists_npy, fconfm = self.computeDist(im_feat,cc_feat)
    ...
    def loadParameters(self, path, use_cuda=False):
        print("Using CUDA: %s" % use_cuda)
        load_checkpoint(path, self.__S__, None, use_cuda=use_cuda, reset_optimizer=True)
...
if __name__ == "__main__":
    ...
    checkpoint_path = "/home/ksw38/RVL/color_syncnet/Wav2Lip/landmarks_checkpoints_gru2/checkpoint_step000690000.pth"
    parser.add_argument('--initial_model', type=str, default=checkpoint_path, help='')
    parser.add_argument('--batch_size', type=int, default='20', help='')
    parser.add_argument('--vshift', type=int, default='15', help='')
    vid_path = "kimi_test.mp4"
    parser.add_argument('--videofile', type=str, default=vid_path, help='')
