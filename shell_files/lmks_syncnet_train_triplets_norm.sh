...
mamba activate vsr
python /home/ksw38/RVL/color_syncnet/Wav2Lip/lmks_syncnet_train_triplets.py --checkpoint_dir 'checkpoints_gru2_norm' --data_root "/home/ksw38/groups/grp_landmarks/nobackup/archive/landmarks_norm/main"