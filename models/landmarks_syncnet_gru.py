...
# Parameters
input_size = 187       # e.g., 68 (x, y) facial landmarks 136
hidden_size = 256 #512
num_layers = 2
bidirectional = True

class SyncNet_landmarks_gru(nn.Module):
    def __init__(self):
        super(SyncNet_landmarks_gru, self).__init__()

        self.face_encoder = nn.GRU(input_size=input_size,
