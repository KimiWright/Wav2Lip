...
if __name__ == "__main__":
    ...
    st_gcn_model_rot_knn, audio_model_rot_knn = load_stgcn_and_audio_models(st_gcn_rot_checkpoint_knn, audio_rot_checkpoint_knn, A_knn, V, use_cuda=use_cuda, rotation=True)
    ...
    y_truth, scores = eval_rot_model(test_data_loader, st_gcn_model_rot_knn, audio_model_rot_knn, device)
    plot_PR_curve("ST_GCN with Rotation using Knn", y_truth, scores)
