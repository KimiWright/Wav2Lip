...
mamba activate vsr
python /home/ksw38/RVL/color_syncnet/Wav2Lip/lmks_syncnet_train_gru2_contrastive_loss.py --checkpoint_dir "contrastive_loss_checkpoints" --checkpoint_path "pre_loaded_audio_checkpoints/audio_loaded.pth"